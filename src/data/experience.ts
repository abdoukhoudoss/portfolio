...
export const experiences: Experience[] = [
    ...
    },
    {
      ...
      responsibilities: [
        "Accueil clients, gestion réservations, traitement des mails",
        "Gestion de caisse, facturation individuelle, gestion tarif de groupe"
      ]
    },
    {
      id: 4,
      ...
      responsibilities: [
        "Gestion d'un commerce de quartier, relation client, politique tarifaire",
